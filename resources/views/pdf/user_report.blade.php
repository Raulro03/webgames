...
<head>
    <meta charset="UTF-8">
    <title>{{__('User Summary ')}} - {{ $user->name }}</title>
    <style>
        body {
...
<div class="container">
    <section>
        ...
        <table class="info-table">
            <tr>
                <td class="highlight">{{__('Name')}}:</td>
                <td>{{ $user->name }}</td>
            </tr>
            <tr>
                <td class="highlight">{{__('Email')}}:</td>
                <td>{{ $user->email }}</td>
            </tr>
            <tr>
                <td class="highlight">{{__('Registration date')}}:</td>
    ...
    <section class="section">
        ...
        <table class="info-table">
            <tr>
                <td class="highlight">{{__('Total Post')}}:</td>
                <td>{{ $user->posts_count }}</td>
            </tr>
            <tr>
                <td class="highlight">{{__('Total Comment')}}:</td>
    ...
    <section class="section">
        <h2>{{__('Distribution of posts by category')}}</h2>
