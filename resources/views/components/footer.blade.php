    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center">
            ...
            <div class="flex justify-center mt-4 space-x-6">
                <a href="https://facebook.com" class="hover:text-white" aria-label="Facebook">
                ...
                <a href="https://twitter.com" class="hover:text-white" aria-label="Twitter">
                ...
                <a href="https://github.com/Raulro03" class="hover:text-white" aria-label="GitHub">
